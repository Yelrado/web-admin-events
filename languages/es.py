...
'All unsaved data will lost, exit anyway?': 'Todos los datos no guardados se perderán, ¿Quieres salir de todos modos?',
...
'Check your conection and try again': 'Prueba tu conección e intenta de nuevo',
...
'Create new element': 'Crear un nuevo elemento',
...
'Delete this element': 'Eliminar este elemento',
'Delete:': 'Eliminar:',
'Demo': 'Demostración',
...
'Do you really want to delete this': '¿Realmente quieres eliminar esto?',
...
'Go to Manager': 'Ir al Administrador',
'Group': 'Grupo',
...
'Make a link with the stage': 'Enlazar con el escenario',
'Manage Cache': 'Gestionar la Caché',
'Manager': 'Administrador',
'Mark as attended': 'Marcar como Asistió',
...
'My Sites': 'Mis Sitios',
'Name': 'Nombre',
'Name of new category': 'Nombre de la nueva categoría',
'Name of new element': 'Nombre del nuevo elemento',
'New': 'Nuevo',
...
'Please, fill the form': 'Por favor, llena el formulario',
'Plugins': 'Plugins',
...
'start': 'inicio',
'Start session to create and see events': 'Inicia sesión para crear y ver eventos',
...
'Your are the owner': 'Tú eres el propietario',
